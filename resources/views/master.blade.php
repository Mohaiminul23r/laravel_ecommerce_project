...
<div class="recommended_items"><!--recommended_items-->
    ...
    <footer id="footer"><!--Footer-->
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © 2019 Online Shopping Center. All rights reserved.</p>
                   <!--  <p class="pull-right">Designed by <span><a target="_blank" href="http://www.themeum.com">Mohai</a></span></p> -->
                </div>
            </div>
        </div>
